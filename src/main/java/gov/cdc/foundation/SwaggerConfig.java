...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("FDNS Reporting Microservice")
				.description("This is the project with the Reporting microservice for generating reports from the data lake in XML, JSON, CSV or XLSX.")
